...
import {GetMarketsAction, DeleteMarketAction, AnnulerAction} from "../redux/market.maintenance/actions/marketActions";
    ...
    return (
        <div>
            <Modal
                ...
                <Modal.Body>
                    <p>
                        Souhaitez-vous supprimer le marché '<strong><i>{market.nom}</i></strong>' ?
                    </p>
                </Modal.Body>
                <Modal.Footer>
                    <Button
...
function MarketsMaintenance({markets, GetMarketsAction, DeleteMarketAction,AnnulerAction}) {
                                    ...
                                    <tr key= {market.id}>
                                        ...
                                        <td>
                                            <div className="row">
                                                ...
                                                <FaEdit style={{marginLeft: "19px"}} onClick={() => {setEditModalShow(true); setMarketData(market); setShowEditModal(true)}}/>
                                                <FaTrash style={{marginLeft: "19px"}} onClick={() => {setDeleteModalShow(true); setMarketData(market); setShowDeleteModal(true)} }/>
                                            </div>
                                            {showEditModal ? 
                                            <EditModal
                                                show={editModalShow}
